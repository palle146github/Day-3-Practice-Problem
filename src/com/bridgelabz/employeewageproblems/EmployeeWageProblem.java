...
public class EmployeeWageProblem {
    ...
    static void EmployeeWageComputation() {// creating a static method to compute employee daily wage
        int dayCount = 1;
        int workHours = 0;
        int empDailywage = 0;
        int isPresent = 0;
    ...
    public static void main(String[] args) {
        EmployeeWageComputation();// calling a Employee Wage Computation static method
    }
}
